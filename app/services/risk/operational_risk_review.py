...
from app.repositories.risk import operational_risk_review as operational_risk_review_repo
from app.repositories.risk import operational_risk_signal as operational_risk_signal_repo
